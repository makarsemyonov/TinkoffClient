...
Позволяет управлять тикерами и счетами, получать историю и текущие цены, создавать рыночные и лимитные ордера, а также выставлять стоп-заявки (Stop Loss / Take Profit).
...
При неправильном тикере вызывает `ValueError`.
...
Если указанное имя отсутствует, вызывает `ValueError`.
